            ...
            <div className='w-full h-[70px]  bg-white flex'>
                ...
                <nav>
                    <div className='md:flex xs:hidden capitalize text-sm pl-32 pt-4 text-blue-950'>
                        ...
                        <a href="http://localhost:3005/career" className='ml-9 text-green-600 border-b-4 border-green-600'>career</a>
            ...
            <div>
                <div className='p-4 bg-white'>
                    <ul className='flex pl-7 '>
                        ...
                        <li className=' pl-4 text-green-600'>career</li>
                    </ul>
            ...
            <div className='w-full h-full md:flex'>
                <div className='md:w-[75%] h-full bg-white md:pl-7'>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                        <div className="container mx-auto p-4">
                            <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                                <h1 className="text-3xl font-semibold mb-4 text-blue-900 dark:text-gray-100">Career</h1>
                                <p className="text-blue-600 dark:text-gray-300 mb-6 font-bold">Mail your resume along with your photograph at :<span className='text-yellow-700'>admission@lnct.com</span> </p>
                                <form className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        <label for="title" className="text-gray-700 dark:text-gray-300 block mb-1">Title</label>
                                        <input type="text" id="title" placeholder="Title" className="border p-2 rounded w-full"></input>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label for="qualification" className="text-gray-700 dark:text-gray-300 block mb-1">Qualification</label>
                                        <input type="text" id="qualification" placeholder="Qualification" className="border p-2 rounded w-full"></input>
                                    </div>
                                    <div>
                                    ...
                                    <div >
                                        <label for="qualification" className="text-gray-700 dark:text-gray-300 block mb-1">Contact No.</label>
                                    ...
                                    <div>
                                        <label for="qualification" className="text-gray-700 dark:text-gray-300 block mb-1">Contact No.</label>
                                        <input type="number" id="qualification" placeholder="Number" className="border p-2 rounded w-full"></input>
                                    </div>
                                    <div>
                                        <label for="qualification" className="text-gray-700 dark:text-gray-300 block mb-1">Qualification</label>
                                        <input type="text" id="qualification" placeholder="Qualification" className="border p-2 rounded w-full"></input>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                        <div className="container mx-auto p-4">
                            <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                                <p className="text-white dark:text-gray-300 mb-6 text-xl p-5 bg-blue-600 rounded-lg">PROFFESIONAL DETAILS</p>
                                <form >
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                        <div>
                                            <label for="city" className="text-gray-700 dark:text-gray-300 block mb-1">Post Applied For :</label>
                                            <input type="text" id="city" placeholder="" className="border p-2 rounded w-full"></input>
                                        </div>
                                        <div>
                                            <label for="state" className="text-gray-700 dark:text-gray-300 block mb-1">Subject :</label>
                                            <input type="text" id="state" placeholder="" className="border p-2 rounded w-full"></input>
                                        </div>
                                        <div>
                                            <label for="state" className="text-gray-700 dark:text-gray-300 block mb-1">Subject Applied For :</label>
                                            <input type="text" id="state" placeholder="" className="border p-2 rounded w-full"></input>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                        <div className="container mx-auto p-4">
                            <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                                ...
                                <p className="text-white dark:text-gray-300 mb-6 text-xl p-5 bg-blue-600 rounded-lg">ADD EXPERIENCE DETAILS</p>
                                <form >
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                        <div className='flex'>
                                            <label for="city" className="text-gray-700 dark:text-gray-300 block mb-1">Post Applied For ? :</label>
                                            <input type="checkbox" id="city" placeholder="Yes" className="border w-14 rounded"></input><span>Yes</span>
                                            <input type="checkbox" id="city" placeholder="No" className="border  w-14  rounded"></input><span>No</span>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                        <div className="container mx-auto p-4">
                            <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                                ...
                                <p className="text-white dark:text-gray-300 mb-6 text-xl p-5 bg-blue-600 rounded-lg">Upload Your Resume</p>
                                <form >
                                    <div>
                                        <label>Upload your resume here : <span className='text-red-600 font-bold'>(Maximum File Type : 5mb)</span></label></div>
                ...
                <div className='w-96 h-full' style={{ backgroundImage: `url('bg.jpg')` }}>
                    ...
                    <div className='w-96 h-full bg-blue-950 '>
                        <div className='h-full'>
                            <div className='flex pt-10 pl-5'>
